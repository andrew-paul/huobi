...
if __name__ == '__main__':
    #print (get_symbols())
    #print (get_accounts())
    get_value = (get_kline('btcusdt','1min',1))
    price=get_dict_value(get_value)
    old_price=price
    get_value1= (get_kline('btcusdt','1min',1))
    new_price = get_dict_value(get_value1)
    chazhi= new_price - old_price
    print (new_price,old_price,chazhi)
